...
@SerialVersionUID(0L)
final case class AssetAmount(
    assetId: _root_.com.google.protobuf.ByteString = _root_.com.google.protobuf.ByteString.EMPTY,
    amount: _root_.scala.Long = 0L
    ) extends scalapb.GeneratedMessage with scalapb.Message[AssetAmount] with scalapb.lenses.Updatable[AssetAmount] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.wavesplatform.protobuf.transaction.AssetAmount = {
    ...
    def withAssetId(__v: _root_.com.google.protobuf.ByteString): AssetAmount = copy(assetId = __v)
    def withAmount(__v: _root_.scala.Long): AssetAmount = copy(amount = __v)
    ...
    def companion = com.wavesplatform.protobuf.transaction.AssetAmount
}

object AssetAmount extends scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.AssetAmount] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.AssetAmount] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.wavesplatform.protobuf.transaction.AssetAmount = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.wavesplatform.protobuf.transaction.AssetAmount] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.wavesplatform.protobuf.transaction.AssetAmount(
  )
  implicit class AssetAmountLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.AssetAmount]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.wavesplatform.protobuf.transaction.AssetAmount](_l) {
  ...
  ): _root_.com.wavesplatform.protobuf.transaction.AssetAmount = _root_.com.wavesplatform.protobuf.transaction.AssetAmount(
    assetId,
    amount
  )
}
