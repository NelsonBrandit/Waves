...
final case class Transaction(
    ...
    fee: _root_.scala.Option[com.wavesplatform.protobuf.transaction.Amount] = None,
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.wavesplatform.protobuf.transaction.Transaction = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 26 =>
            __fee = Option(_root_.scalapb.LiteParser.readMessage(_input__, __fee.getOrElse(com.wavesplatform.protobuf.transaction.Amount.defaultInstance)))
          case 32 =>
            __timestamp = _input__.readInt64()
          case 40 =>
            __version = _input__.readInt32()
          case 810 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Genesis(_root_.scalapb.LiteParser.readMessage(_input__, data.genesis.getOrElse(com.wavesplatform.protobuf.transaction.GenesisTransactionData.defaultInstance)))
          case 818 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Payment(_root_.scalapb.LiteParser.readMessage(_input__, data.payment.getOrElse(com.wavesplatform.protobuf.transaction.PaymentTransactionData.defaultInstance)))
          case 826 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Issue(_root_.scalapb.LiteParser.readMessage(_input__, data.issue.getOrElse(com.wavesplatform.protobuf.transaction.IssueTransactionData.defaultInstance)))
          case 834 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Transfer(_root_.scalapb.LiteParser.readMessage(_input__, data.transfer.getOrElse(com.wavesplatform.protobuf.transaction.TransferTransactionData.defaultInstance)))
          case 842 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Reissue(_root_.scalapb.LiteParser.readMessage(_input__, data.reissue.getOrElse(com.wavesplatform.protobuf.transaction.ReissueTransactionData.defaultInstance)))
          case 850 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Burn(_root_.scalapb.LiteParser.readMessage(_input__, data.burn.getOrElse(com.wavesplatform.protobuf.transaction.BurnTransactionData.defaultInstance)))
          case 858 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Exchange(_root_.scalapb.LiteParser.readMessage(_input__, data.exchange.getOrElse(com.wavesplatform.protobuf.transaction.ExchangeTransactionData.defaultInstance)))
          case 866 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.Lease(_root_.scalapb.LiteParser.readMessage(_input__, data.lease.getOrElse(com.wavesplatform.protobuf.transaction.LeaseTransactionData.defaultInstance)))
          case 874 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.LeaseCancel(_root_.scalapb.LiteParser.readMessage(_input__, data.leaseCancel.getOrElse(com.wavesplatform.protobuf.transaction.LeaseCancelTransactionData.defaultInstance)))
          case 882 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.CreateAlias(_root_.scalapb.LiteParser.readMessage(_input__, data.createAlias.getOrElse(com.wavesplatform.protobuf.transaction.CreateAliasTransactionData.defaultInstance)))
          case 890 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.MassTransfer(_root_.scalapb.LiteParser.readMessage(_input__, data.massTransfer.getOrElse(com.wavesplatform.protobuf.transaction.MassTransferTransactionData.defaultInstance)))
          case 898 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.DataTransaction(_root_.scalapb.LiteParser.readMessage(_input__, data.dataTransaction.getOrElse(com.wavesplatform.protobuf.transaction.DataTransactionData.defaultInstance)))
          case 906 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.SetScript(_root_.scalapb.LiteParser.readMessage(_input__, data.setScript.getOrElse(com.wavesplatform.protobuf.transaction.SetScriptTransactionData.defaultInstance)))
          case 914 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.SponsorFee(_root_.scalapb.LiteParser.readMessage(_input__, data.sponsorFee.getOrElse(com.wavesplatform.protobuf.transaction.SponsorFeeTransactionData.defaultInstance)))
          case 922 =>
            __data = com.wavesplatform.protobuf.transaction.Transaction.Data.SetAssetScript(_root_.scalapb.LiteParser.readMessage(_input__, data.setAssetScript.getOrElse(com.wavesplatform.protobuf.transaction.SetAssetScriptTransactionData.defaultInstance)))
    ...
    def getFee: com.wavesplatform.protobuf.transaction.Amount = fee.getOrElse(com.wavesplatform.protobuf.transaction.Amount.defaultInstance)
    def clearFee: Transaction = copy(fee = None)
    def withFee(__v: com.wavesplatform.protobuf.transaction.Amount): Transaction = copy(fee = Option(__v))
    ...
    def companion = com.wavesplatform.protobuf.transaction.Transaction
}
...
object Transaction extends scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.Transaction] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.wavesplatform.protobuf.transaction.Transaction = {
    ...
    com.wavesplatform.protobuf.transaction.Transaction(
      ...
      __fieldsMap.get(__fields.get(2)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.Amount]],
      ...
      data = __fieldsMap.get(__fields.get(5)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.GenesisTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Genesis)
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(6)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.PaymentTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Payment))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(7)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.IssueTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Issue))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(8)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.TransferTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Transfer))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(9)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.ReissueTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Reissue))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(10)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.BurnTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Burn))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(11)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.ExchangeTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Exchange))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(12)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.Lease))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(13)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseCancelTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.LeaseCancel))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(14)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.CreateAliasTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.CreateAlias))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(15)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.MassTransferTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.MassTransfer))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(16)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.DataTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.DataTransaction))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(17)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SetScriptTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.SetScript))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(18)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SponsorFeeTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.SponsorFee))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(__fields.get(19)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SetAssetScriptTransactionData]].map(com.wavesplatform.protobuf.transaction.Transaction.Data.SetAssetScript))
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.wavesplatform.protobuf.transaction.Transaction] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.wavesplatform.protobuf.transaction.Transaction(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.Amount]]),
        ...
        data = __fieldsMap.get(scalaDescriptor.findFieldByNumber(101).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.GenesisTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Genesis)
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(102).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.PaymentTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Payment))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(103).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.IssueTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Issue))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(104).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.TransferTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Transfer))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(105).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.ReissueTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Reissue))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(106).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.BurnTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Burn))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(107).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.ExchangeTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Exchange))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(108).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.Lease))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(109).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseCancelTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.LeaseCancel))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(110).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.CreateAliasTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.CreateAlias))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(111).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.MassTransferTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.MassTransfer))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(112).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.DataTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.DataTransaction))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(113).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SetScriptTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.SetScript))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(114).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SponsorFeeTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.SponsorFee))
    .orElse[com.wavesplatform.protobuf.transaction.Transaction.Data](__fieldsMap.get(scalaDescriptor.findFieldByNumber(115).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.SetAssetScriptTransactionData]]).map(com.wavesplatform.protobuf.transaction.Transaction.Data.SetAssetScript))
    .getOrElse(com.wavesplatform.protobuf.transaction.Transaction.Data.Empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 3 => __out = com.wavesplatform.protobuf.transaction.Amount
  ...
  sealed trait Data extends _root_.scalapb.GeneratedOneof {
    ...
    def genesis: _root_.scala.Option[com.wavesplatform.protobuf.transaction.GenesisTransactionData] = None
    def payment: _root_.scala.Option[com.wavesplatform.protobuf.transaction.PaymentTransactionData] = None
    def issue: _root_.scala.Option[com.wavesplatform.protobuf.transaction.IssueTransactionData] = None
    def transfer: _root_.scala.Option[com.wavesplatform.protobuf.transaction.TransferTransactionData] = None
    def reissue: _root_.scala.Option[com.wavesplatform.protobuf.transaction.ReissueTransactionData] = None
    def burn: _root_.scala.Option[com.wavesplatform.protobuf.transaction.BurnTransactionData] = None
    def exchange: _root_.scala.Option[com.wavesplatform.protobuf.transaction.ExchangeTransactionData] = None
    def lease: _root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseTransactionData] = None
    def leaseCancel: _root_.scala.Option[com.wavesplatform.protobuf.transaction.LeaseCancelTransactionData] = None
    def createAlias: _root_.scala.Option[com.wavesplatform.protobuf.transaction.CreateAliasTransactionData] = None
    def massTransfer: _root_.scala.Option[com.wavesplatform.protobuf.transaction.MassTransferTransactionData] = None
    def dataTransaction: _root_.scala.Option[com.wavesplatform.protobuf.transaction.DataTransactionData] = None
    def setScript: _root_.scala.Option[com.wavesplatform.protobuf.transaction.SetScriptTransactionData] = None
    def sponsorFee: _root_.scala.Option[com.wavesplatform.protobuf.transaction.SponsorFeeTransactionData] = None
    def setAssetScript: _root_.scala.Option[com.wavesplatform.protobuf.transaction.SetAssetScriptTransactionData] = None
  }
  object Data extends {
    @SerialVersionUID(0L)
  ...
  implicit class TransactionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.Transaction]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.wavesplatform.protobuf.transaction.Transaction](_l) {
    ...
    def fee: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.Amount] = field(_.getFee)((c_, f_) => c_.copy(fee = Option(f_)))
    def optionalFee: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[com.wavesplatform.protobuf.transaction.Amount]] = field(_.fee)((c_, f_) => c_.copy(fee = f_))
  ...
  final val LEASECANCEL_FIELD_NUMBER = 109
  final val CREATEALIAS_FIELD_NUMBER = 110
  final val MASSTRANSFER_FIELD_NUMBER = 111
  final val DATATRANSACTION_FIELD_NUMBER = 112
  final val SETSCRIPT_FIELD_NUMBER = 113
  final val SPONSORFEE_FIELD_NUMBER = 114
  final val SETASSETSCRIPT_FIELD_NUMBER = 115
  def of(
    chainId: _root_.scala.Int,
    senderPublicKey: _root_.com.google.protobuf.ByteString,
    fee: _root_.scala.Option[com.wavesplatform.protobuf.transaction.Amount],
