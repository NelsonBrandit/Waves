...
final case class PaymentTransactionData(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.wavesplatform.protobuf.transaction.PaymentTransactionData = {
    ...
    def withAddress(__v: _root_.com.google.protobuf.ByteString): PaymentTransactionData = copy(address = __v)
    ...
    def companion = com.wavesplatform.protobuf.transaction.PaymentTransactionData
}

object PaymentTransactionData extends scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.PaymentTransactionData] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.PaymentTransactionData] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.wavesplatform.protobuf.transaction.PaymentTransactionData = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.wavesplatform.protobuf.transaction.PaymentTransactionData] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.wavesplatform.protobuf.transaction.PaymentTransactionData(
  )
  implicit class PaymentTransactionDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.PaymentTransactionData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.wavesplatform.protobuf.transaction.PaymentTransactionData](_l) {
  ...
  ): _root_.com.wavesplatform.protobuf.transaction.PaymentTransactionData = _root_.com.wavesplatform.protobuf.transaction.PaymentTransactionData(
    address,
    amount
  )
}
