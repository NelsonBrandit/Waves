...
final case class LeaseTransactionData(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.wavesplatform.protobuf.transaction.LeaseTransactionData = {
    ...
    def withRecipient(__v: com.wavesplatform.protobuf.transaction.Recipient): LeaseTransactionData = copy(recipient = Option(__v))
    ...
    def companion = com.wavesplatform.protobuf.transaction.LeaseTransactionData
}

object LeaseTransactionData extends scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.LeaseTransactionData] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.LeaseTransactionData] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.wavesplatform.protobuf.transaction.LeaseTransactionData = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.wavesplatform.protobuf.transaction.LeaseTransactionData] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TransactionsProto.javaDescriptor.getMessageTypes.get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TransactionsProto.scalaDescriptor.messages(10)
  ...
  lazy val defaultInstance = com.wavesplatform.protobuf.transaction.LeaseTransactionData(
  )
  implicit class LeaseTransactionDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.LeaseTransactionData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.wavesplatform.protobuf.transaction.LeaseTransactionData](_l) {
  ...
  ): _root_.com.wavesplatform.protobuf.transaction.LeaseTransactionData = _root_.com.wavesplatform.protobuf.transaction.LeaseTransactionData(
    recipient,
    amount
  )
}
