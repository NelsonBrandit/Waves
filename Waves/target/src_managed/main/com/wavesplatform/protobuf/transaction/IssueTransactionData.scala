...
final case class IssueTransactionData(
    ...
    description: _root_.com.google.protobuf.ByteString = _root_.com.google.protobuf.ByteString.EMPTY,
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.wavesplatform.protobuf.transaction.IssueTransactionData = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __description = _input__.readBytes()
          case 24 =>
    ...
    def withName(__v: _root_.com.google.protobuf.ByteString): IssueTransactionData = copy(name = __v)
    def withDescription(__v: _root_.com.google.protobuf.ByteString): IssueTransactionData = copy(description = __v)
    ...
    def withScript(__v: com.wavesplatform.protobuf.transaction.Script): IssueTransactionData = copy(script = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PByteString(description)
    ...
    def companion = com.wavesplatform.protobuf.transaction.IssueTransactionData
}

object IssueTransactionData extends scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.IssueTransactionData] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.wavesplatform.protobuf.transaction.IssueTransactionData] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.wavesplatform.protobuf.transaction.IssueTransactionData = {
    ...
    com.wavesplatform.protobuf.transaction.IssueTransactionData(
      ...
      __fieldsMap.get(__fields.get(5)).asInstanceOf[_root_.scala.Option[com.wavesplatform.protobuf.transaction.Script]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.wavesplatform.protobuf.transaction.IssueTransactionData] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.wavesplatform.protobuf.transaction.IssueTransactionData(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).flatMap(_.as[_root_.scala.Option[com.wavesplatform.protobuf.transaction.Script]])
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TransactionsProto.javaDescriptor.getMessageTypes.get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TransactionsProto.scalaDescriptor.messages(13)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = com.wavesplatform.protobuf.transaction.Script
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.wavesplatform.protobuf.transaction.IssueTransactionData(
  )
  implicit class IssueTransactionDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.wavesplatform.protobuf.transaction.IssueTransactionData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.wavesplatform.protobuf.transaction.IssueTransactionData](_l) {
    def name: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.google.protobuf.ByteString] = field(_.name)((c_, f_) => c_.copy(name = f_))
    def description: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.google.protobuf.ByteString] = field(_.description)((c_, f_) => c_.copy(description = f_))
  ...
  def of(
    ...
    description: _root_.com.google.protobuf.ByteString,
  ...
  ): _root_.com.wavesplatform.protobuf.transaction.IssueTransactionData = _root_.com.wavesplatform.protobuf.transaction.IssueTransactionData(
    name,
    description,
    amount,
    decimals,
