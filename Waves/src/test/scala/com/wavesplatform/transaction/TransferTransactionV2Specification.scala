...
class TransferTransactionV2Specification
  ...
  property(
    "VersionedTransferTransactionSpecification serialization from TypedTransaction") {
    forAll(transferV2Gen) { tx: TransferTransactionV2 =>
  ...
  property(
    "VersionedTransferTransactionSpecification id doesn't depend on proof") {
  ...
  private def assertTxs(first: TransferTransactionV2,
                        second: TransferTransactionV2): Unit = {
