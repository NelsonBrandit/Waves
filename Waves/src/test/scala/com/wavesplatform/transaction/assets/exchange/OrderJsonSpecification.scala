...
class OrderJsonSpecification
  ...
  property("Read Order from json") {
    ...
    json.validate[Order] match {
      ...
      case JsSuccess(o, _) =>
        ...
        o.matcherPublicKey shouldBe PublicKeyAccount(
          Base58.decode("DZUxn4pC7QdYrRqacmaAJghatvnn1Kh1mkE2scZoLuGJ").get)
        o.assetPair.amountAsset.compatId.get shouldBe ByteStr
          .decodeBase58("29ot86P3HoUZXH1FCoyvff7aeZ3Kt7GqPwBWXncjRF2b")
          .get
        o.assetPair.priceAsset.compatId.get shouldBe ByteStr
          .decodeBase58("GEtBMkg419zhDiYRXKwn2uPcabyXKqUqj4w3Gcs1dq44")
          .get
        o.price shouldBe 0
        o.amount shouldBe 0
    ...
    jsonOV3.validate[Order] match {
      ...
      case JsSuccess(o, _) =>
        ...
        o.matcherPublicKey shouldBe PublicKeyAccount(
          Base58.decode("DZUxn4pC7QdYrRqacmaAJghatvnn1Kh1mkE2scZoLuGJ").get)
        o.assetPair.amountAsset shouldBe IssuedAsset(
          ByteStr
            .decodeBase58("29ot86P3HoUZXH1FCoyvff7aeZ3Kt7GqPwBWXncjRF2b")
            .get)
        o.assetPair.priceAsset shouldBe IssuedAsset(
          ByteStr
            .decodeBase58("GEtBMkg419zhDiYRXKwn2uPcabyXKqUqj4w3Gcs1dq44")
            .get)
        o.price shouldBe 0
        ...
        o.expiration shouldBe 0
        o.signature shouldBe Base58.decode("signature").get
        o.matcherFeeAssetId shouldBe IssuedAsset(
          ByteStr
            .decodeBase58("29ot86P3HoUZXH1FCoyvff7aeZ3Kt7GqPwBWXncjRF2b")
            .get)
    }
  ...
  property("Json Reads PublicKeyAccount") {
    ...
    publicKey.bytes shouldBe PublicKeyAccount(Base58.decode(base58Str).get)
      .bytes
