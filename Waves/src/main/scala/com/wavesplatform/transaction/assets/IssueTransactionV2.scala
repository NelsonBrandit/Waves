...
case class IssueTransactionV2 private (chainId: Byte,
  ...
  override val json: Coeval[JsObject] = Coeval.evalOnce(
    issueJson() ++ Json.obj("chainId" -> chainId,
...
object IssueTransactionV2
  ...
  val byteTailDescription: ByteEntity[IssueTransactionV2] = {
    (
      ...
      OptionBytes(index = tailIndex(10),
                  name = "Script",
                  nestedByteEntity = ScriptBytes(tailIndex(10), "Script")),
