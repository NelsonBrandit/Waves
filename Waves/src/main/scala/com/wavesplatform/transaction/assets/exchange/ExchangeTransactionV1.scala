  ...
  override val bodyBytes: Coeval[Array[Byte]] =
    Coeval.evalOnce(
      Array(builder.typeId) ++
        ...
        buyOrder.bytes() ++ sellOrder.bytes() ++ Longs
        .toByteArray(price) ++ Longs.toByteArray(amount) ++
...
object ExchangeTransactionV1
    extends TransactionParserFor[ExchangeTransactionV1]
