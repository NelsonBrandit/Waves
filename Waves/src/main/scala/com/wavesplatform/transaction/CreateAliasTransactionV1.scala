...
case class CreateAliasTransactionV1 private (sender: PublicKeyAccount,
                                             alias: Alias,
                                             fee: Long,
                                             timestamp: Long,
                                             signature: ByteStr)
...
object CreateAliasTransactionV1
    extends TransactionParserFor[CreateAliasTransactionV1]
