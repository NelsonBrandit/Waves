              ...
              case Some(x) =>
                x match {
                  ...
                  case TransferTransactionV1 =>
                    TransactionFactory.transferAssetV1(
                      txJson.as[TransferV1Request],
                      senderPk)
                  case TransferTransactionV2 =>
                    TransactionFactory.transferAssetV2(
                      txJson.as[TransferV2Request],
                      senderPk)
                  case ReissueTransactionV1 =>
                    TransactionFactory.reissueAssetV1(
                      txJson.as[ReissueV1Request],
                      senderPk)
                  case ReissueTransactionV2 =>
                    TransactionFactory.reissueAssetV2(
                      txJson.as[ReissueV2Request],
                      senderPk)
                  ...
                  case DataTransaction =>
                    TransactionFactory.data(txJson.as[DataRequest], senderPk)
                  case InvokeScriptTransaction =>
                    TransactionFactory.invokeScript(
                      txJson.as[InvokeScriptRequest],
                      senderPk)
                  ...
                  case ExchangeTransactionV1 =>
                    TransactionFactory.exchangeV1(
                      txJson.as[SignedExchangeRequest],
                      senderPk)
                  case ExchangeTransactionV2 =>
                    TransactionFactory.exchangeV2(
                      txJson.as[SignedExchangeRequestV2],
                      senderPk)
                }
            }
          }
