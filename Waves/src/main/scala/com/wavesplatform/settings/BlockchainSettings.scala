  ...
  val MAINNET = GenesisSettings(
    ...
    List(
      GenesisTransactionSettings(
        ...
        Constants.UnitsInWave * Constants.TotalWaves - 5 * Constants.UnitsInWave),
  ...
  val TESTNET = GenesisSettings(
    ...
    List(
      GenesisTransactionSettings(
        ...
        (Constants.UnitsInWave * Constants.TotalWaves * 0.04).toLong),
      GenesisTransactionSettings(
        "3NBVqYXrapgJP9atQccdBPAgJPwHDKkh6A8",
        (Constants.UnitsInWave * Constants.TotalWaves * 0.02).toLong),
      GenesisTransactionSettings(
      ...
      blockchainType match {
        ...
        case BlockchainType.CUSTOM =>
          val addressSchemeCharacter = config
            .as[String](s"$configPath.custom.address-scheme-character")
            .charAt(0)
          val functionalitySettings = config.as[FunctionalitySettings](
            "waves.blockchain.custom.functionality")
          val genesisSettings =
            config.as[GenesisSettings]("waves.blockchain.custom.genesis")
